...
@section('content')
   ...
   <form action="{{ url('/admin/items/'.$data->id ) }}" method="post" novalidate enctype="multipart/form-data">
    @method("put")
    @csrf()
   <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="item_name" value="{{ old('item_name',$data->item_name) }}" >
    ...
    <div class="mb-3">
        ...
        <select class="form-select" name="brand_id">
            @foreach($brands as $brand)
                <option value="{{ $brand->id }}" {{ old('brand_id',$data->brand_id) == $brand->id ? "selected" : "" }}>{{$brand->brand_name}}</option>
            @endforeach
        </select>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="item_code" autofocus value="{{ old('item_code',$data->item_code) }}" >
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="price" autofocus value="{{ old('price',$data->price) }}" >
        @if( $errors->has('price') )

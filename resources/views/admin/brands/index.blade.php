...
@section('content')
<a href="{{ url('/admin/brands/create') }}" class="btn btn-primary mb-3">
...
<table id="table" class="display">
        ...
        <tr class="text-center">
            <td>
                <a href="{{ url('admin/brands/' .$item->id ) }}" class="btn btn-info">
                <i class="fa-solid fa-bars"></i>
                Show
                </a>
                <a href="{{ url('admin/brands/' .$item->id. '/edit') }}" class="btn btn-secondary">
